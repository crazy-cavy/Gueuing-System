...
namespace GueuingSystem
{
    public partial class frmMain : Form
    {
        ...
        new private bool  Closing = false;//是否正在关闭串口，执行Application.DoEvents，并阻止再次invoke  
        ...
        public static string odbcConnStr = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + Application.StartupPath + "\\GueuingSystemDataBase.accdb";
        //用户名
        ...
        void comm_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            try
            {
                ...
                if (data_1_catched)
                {
                    ...
                    for (int i = 0; i < len; i++)
                    {
                        data = data + binary_data_1[i+3].ToString("X2") + " ";
                    }
                    //更新界面  
